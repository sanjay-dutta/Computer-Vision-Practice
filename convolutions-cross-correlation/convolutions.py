...
ap.add_argument("-i", "--image", required=False,
                help="path to the input image", default='jemma.png')  # Provide a default image path
args = vars(ap.parse_args())

# If running in an IDE or a situation where command line arguments can't be passed,
# ensure that the default image path ('jemma.png') is correct and the image exists in the specified directory.
